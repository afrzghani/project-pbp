...
class BadgeService
{
    ...
    public function checkAndAward(User $user, ?string $context = null): array
    {
        ...
        // Check based on context for optimization
        switch ($context) {
            case 'note_created':
    ...
    public function checkEngagementBadges(User $user): array
    {
        ...
        // Total likes received on all notes
        ...
        // Check single note likes (viral badges)
    ...
    public function checkCommunityBadges(User $user): array
    {
        ...
        // Comments received on user's notes
    ...
    public function checkLeaderboardBadges(User $user): array
    {
        ...
        // For leaderboard badges, requirement_value is the max rank (e.g., 50 means top 50)
    ...
    {
        // Get user's current streak from activity logs
    ...
    public function checkSpecialBadges(User $user): array
    {
        ...
        // Early adopter - joined in first month (adjust date as needed)
        $launchDate = now()->subMonth(); // Placeholder, adjust to actual launch date
        ...
        // Helpful - total engagement (likes + bookmarks received)
    ...
    {
        // Get activity dates from activity_logs
