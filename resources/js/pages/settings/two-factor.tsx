        ...
        <AppLayout breadcrumbs={breadcrumbs}>
            ...
            <SettingsLayout>
                <div className="space-y-6">
                    <HeadingSmall
                        title="Otentikasi Dua Faktor"
                        description="Kelola pengaturan otentikasi dua faktor akun anda."
                    />
                    {twoFactorEnabled ? (
                        <div className="flex flex-col items-start justify-start space-y-4">
                            ...
                            <p className="text-muted-foreground">
                                ...
                                diminta PIN aman yang acak saat login, yang bisa diambil dari 
                        ...
                        <div className="flex flex-col items-start justify-start space-y-4">
                            ...
                            <p className="text-muted-foreground">
                                Saat Anda mengaktifkan otentikasi dua faktor, Anda akan
                                diminta PIN aman saat login. PIN ini bisa diambil dari aplikasi 
